...
public class TopTracksFragment extends Fragment {
    ...
    @BindView(R.id.fragment_top_tracks_recycler)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.from(getContext()).inflate(R.layout.fragment_top_tracks, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        api.getTopTracks(10, 0, "short_term", new Callback<SpotifyBaseResponse<TrackFullObject>>() {
                    @Override
                    public void onResponse(Call<SpotifyBaseResponse<TrackFullObject>> call, Response<SpotifyBaseResponse<TrackFullObject>> response) {
                        adapter.addItemNoNotify(Utils.createSeparatorFromStrings(
                                getContext(),
                                R.string.top_separator_left_tracks,
        ...
        api.getTopTracks(10, 0, "medium_term", new Callback<SpotifyBaseResponse<TrackFullObject>>() {
                    @Override
                    public void onResponse(Call<SpotifyBaseResponse<TrackFullObject>> call, Response<SpotifyBaseResponse<TrackFullObject>> response) {
                        adapter.addItemNoNotify(Utils.createSeparatorFromStrings(
                                getContext(),
        ...
        api.getTopTracks(10, 0, "long_term", new Callback<SpotifyBaseResponse<TrackFullObject>>() {
                    @Override
                    public void onResponse(Call<SpotifyBaseResponse<TrackFullObject>> call, Response<SpotifyBaseResponse<TrackFullObject>> response) {
                        adapter.addItemNoNotify(Utils.createSeparatorFromStrings(
                                getContext(),
